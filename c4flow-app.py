...
st.markdown("""🎯 O protótipo que revela onde estão, quanto geram de créditos e os cruzamentos espaciais dos projetos de Carbono no Brasil oferecendo uma visão abrangente de cada iniciativa.""")
